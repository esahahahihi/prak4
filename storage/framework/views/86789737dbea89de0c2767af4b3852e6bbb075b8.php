...
mb-0 bg-white">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="<?php echo e(route('employees.show', ['employee' => 1])); ?>"
                                    class="btn btn-outline-dark btn-sm me-2"><i class="bi-person-lines-fill"></i></a>
                                <a href="<?php echo e(route('employees.edit', ['employee' => 1])); ?>"
...
btn-outline-dark btn-sm me-2"><i
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="<?php echo e(route('employees.show', ['employee' => 2])); ?>"
                                    class="btn btn-outline-dark btn-sm me-2"><i class="bi-person-lines-fill"></i></a>
                                <a href="<?php echo e(route('employees.edit', ['employee' => 2])); ?>"
                                    class="btn btn-outline-dark btn-sm me-2"><i class="bi-pencil-square"></i></a>
                                <div>
...
btn-outline-dark btn-sm me-2"><i
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="<?php echo e(route('employees.show', ['employee' => 3])); ?>"
                                    class="btn btn-outline-dark btn-sm me-2"><i class="bi-person-lines-fill"></i></a>
                                <a href="<?php echo e(route('employees.edit', ['employee' => 3])); ?>"
                                    class="btn btn-outline-dark btn-sm me-2"><i class="bi-pencil-square"></i></a>
                                <div>
...
<?php /**PATH E:\IT TELKOM\Semester 6\Pemrograman Framework\praktikum4\resources\views/employee/index.blade.php ENDPATH**/ ?>